...
import { FaHistory, FaUsers, FaUserShield, FaDownload, FaCoins } from "react-icons/fa"
      ...
      <div className="container2_DrawaerLeftSidebar">
        <div className="Drawer_leftsidebar">
          ...
          <NavLink to={'/groups'} className="icon_sidebar_div">
            <p>
              <FaUsers size={22} className='icon_sidebar' style={{ margin: "auto 0.7rem" }} />
              <div className="text_sidebar_icon">Groups</div>
            </p>
          </NavLink>
          <NavLink to={'/private-chat'} className="icon_sidebar_div">
            <p>
              <FaUserShield size={22} className='icon_sidebar' style={{ margin: "auto 0.7rem" }} />
        ...
        <div className="libraryBtn_Drawerleftsidebar">
          ...
          <NavLink to={'/downloads'} className="icon_sidebar_div">
            <p>
              <FaDownload size={22} className='icon_sidebar' style={{ margin: "auto 0.7rem" }} />
              <div className="text_sidebar_icon">Downloads</div>
            </p>
          </NavLink>
          <NavLink to={'/profile'} className="icon_sidebar_div">
            <p>
              <FaCoins size={22} className='icon_sidebar' style={{ margin: "auto 0.7rem" }} />
